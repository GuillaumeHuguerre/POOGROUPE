...
public:
    ...
    void setupUi(QWidget *CarteClass)
    {
        ...
        label->setPixmap(QPixmap(QString::fromUtf8("fond de carte.png")));
        label->setScaledContents(true);
        pushButton = new QPushButton(CarteClass);
        pushButton->setObjectName(QStringLiteral("pushButton"));
        pushButton->setGeometry(QRect(510, 30, 31, 31));
        pushButton->setStyleSheet(QStringLiteral("background-color:rgba(0,0,0,0);"));
        QIcon icon;
        icon.addFile(QStringLiteral("croix.png"), QSize(), QIcon::Normal, QIcon::Off);
